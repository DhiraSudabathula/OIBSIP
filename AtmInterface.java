   ...
   public void withDraw(){
        ...
        try{
            if(balance >= amount){
                ...
                String s = "Amount widthdrawn : "+amount;
   ...
   public void deposit(){
    ...
    try{
        if(amount <= 25000f){
            ...
            String s = "Amount deposited : "+amount;
            transactionHistory = transactionHistory.concat(s);
        }
        else{
            System.out.println("Amount Limit is exceeded (Limit is Rs.25000.0)");
        }
    }
    catch(Exception e){
    }
    ...
    try{
        if(balance >= amount){
            if(amount <= 25000f){
                ...
                System.out.println("Amount Limit is exceeded (Limit is Rs.25000.00 )");
            }
        }
        else{
            System.out.println("Insufficient Balance in your account.");
                ...
                if(ba.login()){
                    ...
                    while(!isFinish){
                        ...
                        switch(ch){
                            ...
                            case 6:{
                                System.out.println("Thankyou "+ba.name );
                                System.exit(0);
                                break;
                            }
                        }
